...
**Etsy Scraper** — Scrape Etsy products, shops, reviews, and listing data

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/etsy-scraper?style=social)
...
>
> **Search intent:** collect public Etsy data for price monitoring, catalog enrichment, and product research. Related topics: ecommerce scraper, etsy data, web scraping, python, data extraction.

## What this project is for

`etsy-scraper` is an implementation-focused Python project for collecting public Etsy data. It is designed around one practical job: turn a query such as **"wireless headphones"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/etsy-scraper.git
cd etsy-scraper
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "Etsy", "category": "E-commerce Scrapers"}
  }
}
```
